...
//             About us
//           </Link>
//           <Link to="/contact" className="link link-hover hover:text-gray-500">
//             Contact
//           </Link>
//           <Link to="/jobs" className="link link-hover hover:text-gray-500">
//             Jobs
//           </Link>
//           <Link to="/press-kit" className="link link-hover hover:text-gray-500">
//             Press kit
//           </Link>
//         </nav>
      ...
      <div className="flex flex-col pb sm:items-center sm:justify-between sm:mx-auto text-center ">
          ...
          <div className="flex mt-4 justify-center sm:mt-0 mx-auto">
              ...
              <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                  ...
                  <span className="sr-only text-gray-950">GitHub account</span>
              </a>
              <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                  <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
